...
const QuestionSchema = z.object({
  ...
  vertical: z.union([z.string(), z.array(z.string())]).optional(),
  program: z.union([z.string(), z.array(z.string())]).optional(),
  paper: z.union([z.string(), z.array(z.string())]).optional(),
  chapter: z.union([z.string(), z.array(z.string())]).optional(),
  exam_set: z.union([z.string(), z.array(z.string())]).optional(),
  board: z.union([z.string(), z.array(z.string())]).optional(),
